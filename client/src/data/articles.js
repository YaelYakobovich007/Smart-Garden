/**
 * Articles Data - Gardening Tips and Educational Content
 * 
 * This file contains hardcoded article data for the Smart Garden app.
 ...
 * 
 * The articles provide educational content to help users with
 * gardening best practices, plant care, and smart gardening techniques.
 */

/**
 * Array of gardening articles with full content and metadata
 * Articles are sourced from reputable gardening websites and adapted
 * for the Smart Garden app's educational content section.
 */
export const articles = [
  {
    ...
    readTime: "8 min read",
    image: require('../../assets/images/articles/10 Organic Fertilizers Every Gardener Should Use to Boost Plant Growth Naturally.jpg'),
    content: `
...
Remember, the best fertilizer is the one that works for your specific garden conditions and plant needs. Start with a few options and observe how your plants respond to find the perfect combination for your garden.
  ...
  },
  {
    ...
    readTime: "6 min read",
    image: require('../../assets/images/articles/Underrated plants.jpg'),
    content: `
...
Remember, the best plants for your garden are the ones that thrive in your specific conditions. Don't be afraid to try something different - you might discover your new favorite plant!
  ...
  },
  {
    ...
    category: "Care Tips",
    readTime: "5 min read",
    image: require('../../assets/images/articles/6 Easy Ways To Tell If Your Plants Need Watering.jpg'),
    content: `
...
Remember, it's better to underwater than overwater. Most plants can recover from being slightly dry, but overwatering can quickly kill a plant. Use these methods together to develop your watering intuition and keep your plants healthy and thriving.
  ...
  },
  {
    ...
    category: "Care Tips",
    readTime: "6 min read",
    image: require('../../assets/images/articles/Heres Why Morning Is the Best Time to Water Plants.jpg'),
    content: `
...
Remember, while morning watering is ideal, the most important thing is to water your plants when they need it. If you can't water in the morning, afternoon watering is still effective. The key is to be consistent and attentive to your plants' needs.
  ...
  },
  {
    ...
    category: "Technology",
    readTime: "7 min read",
    image: require('../../assets/images/articles/The Benefits of Automatic Irrigation Over Hand Watering.jpg'),
    content: `
